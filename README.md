...
3. You'll be coding your solution in `times.rb`: 
  ...
  * Fill out the content of the `using_times` method so that calling it will `puts` the desired phrase, `"Wingardium Leviosa"` seven times by using the `using_times` keyword.  
